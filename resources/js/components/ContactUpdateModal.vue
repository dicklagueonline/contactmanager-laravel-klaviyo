...
export default {
  ...
  watch: {
    ...
    "contactData.id": function (id) {
      this.id = id;
    },
    "contactData.name": function (name) {
      this.name = name;
    },
    "contactData.email": function (email) {
      this.email = email;
    },
    "contactData.phone": function (phone) {
      this.phone = phone;
    },
  },
  methods: {
    ...
    updateContact: function () {
      axios({
        ...
        .then((xhr) => {
          this.$emit("contact:updated", xhr.data.data);
          this.$emit("input", false);
        })
        .catch((err) => {
